    ...
    <div className="max-w-4xl mx-auto p-4 space-y-6">
      <header className="space-y-1">
        <h1 className="text-2xl font-semibold">
          Statistika: Položili iz prvog puta
        </h1>
        <p className="text-sm text-gray-600">
          Procena uspešnosti kandidata na prvom izlasku, sa filterima po
          autoškoli i statusu “nije moj kandidat”.
        </p>
      </header>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
        ...
        <div className="space-y-2">
          ...
          <div className="text-sm text-gray-700">
            Položili iz prvog puta: <b>{passedFirst}</b> od <b>{total}</b>{' '}
            kandidata sa bar jednim izlaskom.
          </div>
          <ul className="text-sm text-gray-600 list-disc list-inside">
            <li>
              Prvi izlazak je određen najranijim datumom ispita (a u istom danu
              najranijim unosom).
            </li>
            <li>
              Filteri se primenjuju po kandidatu (autoškola i “nije moj
              kandidat”).
            </li>
          </ul>
        </div>
